...
reqsjobid<-dbGetDistinct(mongo, req, "requisition_id")
idcjobid<-dbGetDistinct(mongo, idcc, "requisition_id")
requisitionList<-setdiff(reqsjobid,idcjobid)
for(m in 1:length(requisitionList)){
